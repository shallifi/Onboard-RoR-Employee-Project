class EmployeesController < ApplicationController
    ...
    def employee_params
        params.require(:employee).permit(:first_name, :last_name, :new_to_scc, :badge_photo,:driving_for_position, :transporting_children, :attending_preservice, :start_date , :agency_id, :department_id, :office_id, :extension, :additional_info,:title_id, need_ids: [])
    end
